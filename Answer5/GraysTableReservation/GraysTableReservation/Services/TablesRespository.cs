...
using GraysTableReservation.Services.Domain;

namespace GraysTableReservation.Services
{
    ...
    public class TablesRepository : ITablesRepository
    {
        ...
        public List<GraysTableReservation.Models.Table> GetAllTables()
        {
            var query = from t in QueryTables()
                        select new GraysTableReservation.Models.Table { TableId = t.Id, MaxOccupancy = t.MaxOccupancy };
